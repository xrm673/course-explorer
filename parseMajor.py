...
major_left=None,major_l_data=None,minor1=None,minor2=None,minor3=None):
    if college == 'A&S':
        if major_displayed == 'ARTH':
            return parse_ARTH_CAS(course_data,courses_taken,major_d_data,
            major_left,major_l_data,minor1,minor2,minor3)
...
major_l_data=None,minor1=None,minor2=None,minor3=None):
...
major_l_data=None,minor1=None,minor2=None,minor3=None):
    ...
    practicum,courses_taken,'A&S',"CS",major_left,major_l_data,minor1,minor2,
    minor3)
...
major_l_data=None,minor1=None,minor2=None,minor3=None):
    ...
    statistics,courses_taken,'A&S',"INFO",major_left,major_l_data,minor1,minor2,
    minor3)
